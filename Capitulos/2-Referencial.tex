\chapter{Principais comandos LATEX}
...
\section{Lista enumerada alfabética}
...
\section{Lista enumerada numérica}
...
Segundo \citeonline{FROZZA_2020}, ...

\section{URL}
\url{https://mooc.geati.camboriu.ifc.edu.br/}

Temos dois exemplos, a figura~\ref{fig:exemploFig1} e a figura~\ref{fig:exemploFig2}.

\section{Nota de rodapé}

O uso da linguagem \textit{Python}\footnote{\textit{Python} - \url{http:\\www.python.org}} é muito indicado para....
...
A Figura \ref{fig:exemplo_png} é referenciada aqui.
